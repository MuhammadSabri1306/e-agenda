...
.collapse-account {
	@apply absolute top-full right-0 min-w-[15rem] mt-2 bg-white rounded border shadow-lg overflow-hidden grid grid-cols-1 z-[2];
}
...
.collapse-item {
	@apply text-sm w-full flex items-center font-bold text-center p-4 text-gray-700 transition-colors bg-white hover:bg-gray-100 focus:bg-gray-100;
}
