...
const showInstructionText = computed(() => {
	...
	const showIfNotLoaded = !isLoaded && !isAvailable && !isRegistSuccess.value;
	return showIfLoaded || showIfNotLoaded;
});
...
<template>
	<div class="form-regist">
		...
		<div class="px-8 py-4 pt-10">
			...
			<p v-if="showInstructionText" class="text-gray-700 mb-8">Silahkan mengisi absensi rapat dengan melengkapi data anda di form berikut.</p>
			...
			<form v-if="isAvailable && !isRegistSuccess" @submit.prevent="onLogin">
